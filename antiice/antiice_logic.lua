...
-- controls
defineProperty("soi21_on", globalPropertyi("sim/custom/switchers/eng/soi21_on")) -- выключатель СОИ 21
defineProperty("soi21_test", globalPropertyi("sim/custom/buttons/eng/soi21_test")) -- проверка СОИ 21


defineProperty("antiice_slats", globalPropertyi("sim/custom/switchers/eng/antiice_slats")) -- противообледенители
defineProperty("antiice_eng_1", globalPropertyi("sim/custom/switchers/eng/antiice_eng_1")) -- противообледенители
defineProperty("antiice_eng_2", globalPropertyi("sim/custom/switchers/eng/antiice_eng_2")) -- противообледенители
defineProperty("antiice_eng_3", globalPropertyi("sim/custom/switchers/eng/antiice_eng_3")) -- противообледенители
defineProperty("antiice_wing", globalPropertyi("sim/custom/switchers/eng/antiice_wing")) -- противообледенители

defineProperty("window_heat_1", globalPropertyi("sim/custom/switchers/ovhd/window_heat_1")) -- обогрев стекол. -1 - слабо, 0 - выкл, 1 - сильно
defineProperty("window_heat_2", globalPropertyi("sim/custom/switchers/ovhd/window_heat_2")) -- обогрев стекол. -1 - слабо, 0 - выкл, 1 - сильно
defineProperty("window_heat_3", globalPropertyi("sim/custom/switchers/ovhd/window_heat_3")) -- обогрев стекол. -1 - слабо, 0 - выкл, 1 - сильно

defineProperty("pitot_heat_1", globalPropertyi("sim/custom/switchers/ovhd/pitot_heat_1")) -- обогрев ППД лев
defineProperty("pitot_heat_2", globalPropertyi("sim/custom/switchers/ovhd/pitot_heat_2")) -- обогрев ППД прав
defineProperty("pitot_heat_3", globalPropertyi("sim/custom/switchers/ovhd/pitot_heat_3")) -- обогрев ППД АБСУ
...
--defineProperty("hot_tube_t", globalPropertyf("sim/custom/bleed/hot_tube_t")) -- температура горячего воздуха в трубопроводе
...
--defineProperty("termo", globalPropertyf("sim/weather/temperature_ambient_c")) -- тепература воздуха xp11
defineProperty("termo", globalPropertyf("sim/weather/region/atmosphere_alt_temperature_c")) -- тепература воздуха xp12
...
-- results
defineProperty("ice_detected", globalPropertyi("sim/custom/antiice/ice_detected")) -- обнаружен лед
defineProperty("ice_detect_ok", globalPropertyi("sim/custom/antiice/ice_detect_ok")) -- система СОИ работает

defineProperty("ice_window_heat_on", globalPropertyi("sim/cockpit2/ice/ice_window_heat_on")) -- обогрев стекла в симе

defineProperty("window_ice_1", globalPropertyf("sim/custom/anim/window_ice_1")) -- уровень льда на стеклах
defineProperty("window_ice_2", globalPropertyf("sim/custom/anim/window_ice_2")) -- уровень льда на стеклах
defineProperty("window_ice_3", globalPropertyf("sim/custom/anim/window_ice_3")) -- уровень льда на стеклах
defineProperty("window_ice_4", globalPropertyf("sim/custom/anim/window_ice_4")) -- уровень льда на стеклах
...
defineProperty("wing_heating", globalPropertyi("sim/custom/antiice/wing_heating")) -- работает обогрев крыла
defineProperty("slat_heating", globalPropertyi("sim/custom/antiice/slat_heating")) -- работает обогрев крыла

defineProperty("ai_27_L_cc", globalPropertyf("sim/custom/antiice/ai_27_L_cc")) -- нагрузка на сеть
defineProperty("ai_27_R_cc", globalPropertyf("sim/custom/antiice/ai_27_R_cc")) -- нагрузка на сеть

defineProperty("ai_115_1_cc", globalPropertyf("sim/custom/antiice/ai_115_1_cc")) -- нагрузка на сеть
defineProperty("ai_115_2_cc", globalPropertyf("sim/custom/antiice/ai_115_2_cc")) -- нагрузка на сеть
defineProperty("ai_115_3_cc", globalPropertyf("sim/custom/antiice/ai_115_3_cc")) -- нагрузка на сеть

defineProperty("eng_heat_open_1", globalPropertyi("sim/custom/antiice/eng_heat_open_1")) -- открыта заслонка обогрева двигателя
defineProperty("eng_heat_open_2", globalPropertyi("sim/custom/antiice/eng_heat_open_2")) -- открыта заслонка обогрева двигателя
defineProperty("eng_heat_open_3", globalPropertyi("sim/custom/antiice/eng_heat_open_3")) -- открыта заслонка обогрева двигателя



-- gauges
defineProperty("wing_heat_t", globalPropertyf("sim/custom/antiice/wing_heat_t")) -- температура обогрева крыла
defineProperty("stab_heat_t", globalPropertyf("sim/custom/antiice/stab_heat_t")) -- температура обогрева стабилизатора
