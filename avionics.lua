...
print("AVIONICS BUILD CHECK: KLN90 {} embed removed 2026-08-13, if you see this the fix is loaded")
size = { 2048, 2048 }
...
components = {
	...
	compass_adf_driver {}, -- creates/drives radio compass needle datarefs (compass_adf1/2)
	uns_gauge_driver {}, -- creates/drives UNS power/brightness/VOR + altimeter needle datarefs
	...
	-- KLN90 {} removed 2026-08-13: this was the pre-rename original device UNS
	-- was ported from. It was still embedded here at the exact same panel
	-- position as UNS, running and drawing unconditionally regardless of
	-- mode — this is very likely why UNS mode kept showing KLN/GNS-looking
	-- content no matter what. UNS now has sole ownership of this screen slot.
