...
defineProperty("apu_rpm", globalPropertyf("sim/custom/gauges/eng/apu_rpm")) -- обороты ВСУ. 0-100%
defineProperty("apu_egt_gau", globalPropertyf("sim/custom/gauges/eng/apu_egt")) -- ТВГ ВСУ. 0 - 900 C
defineProperty("apu_oil_temp", globalPropertyf("sim/custom/gauges/eng/apu_oil_temp")) -- температура масла ВСУ -50 - 150 C




-- lamps
defineProperty("low_oil", globalPropertyf("sim/custom/lights/apu/low_oil")) -- масла мало
defineProperty("low_oil_press", globalPropertyf("sim/custom/lights/apu/low_oil_press")) -- Р масла
defineProperty("high_temp", globalPropertyf("sim/custom/lights/apu/high_temp")) -- предельная температура
defineProperty("high_rpm", globalPropertyf("sim/custom/lights/apu/high_rpm")) -- предельные обороты
defineProperty("pta6_fail", globalPropertyf("sim/custom/lights/apu/pta6_fail")) -- ПТА 6А неисправн
defineProperty("doors_open", globalPropertyf("sim/custom/lights/apu/doors_open")) -- створки открыты
defineProperty("fuel_press", globalPropertyf("sim/custom/lights/apu/fuel_press")) -- Р топлива
defineProperty("start_ready", globalPropertyf("sim/custom/lights/apu/start_ready")) -- Готов к запуску
defineProperty("work_mode", globalPropertyf("sim/custom/lights/apu/work_mode")) -- Выход на режим
defineProperty("start_apu", globalPropertyf("sim/custom/lights/apu/start_apu")) -- запусти ВСУ
...
defineProperty("cockpit_window_left", globalPropertyf("sim/custom/anim/cockpit_window_left")) -- открытие форточки
defineProperty("cockpit_window_right", globalPropertyf("sim/custom/anim/cockpit_window_right")) -- открытие форточки
...
-- lamp sources
defineProperty("test_lamps", globalPropertyi("sim/custom/buttons/lamp_test_apu")) -- кнопка проверки ламп панели ВСУ
...
defineProperty("gear_vent_set", globalPropertyi("sim/custom/switchers/eng/gear_fan")) -- вентиляция шасси
...
local function lamps()
	...
	-- "Р МАСЛА" — горит когда давление ниже нормы
	-- на стоянке (RPM=0): горит всегда (давление=0)
	-- при раскрутке: гаснет автоматически когда RPM > 23% (давление > 1 кгс/см²)
	-- при работе (RPM > 45%): горит если давление упало ниже нормы
	...
	local low_oil_brt = 0
	-- "УРОВЕНЬ МАСЛА" — горит только когда main_sw включён и масло действительно мало
	-- не горит при неинициализированном датарефе (oil_q = 0 при старте)
