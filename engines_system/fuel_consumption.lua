...
local rev_corr_tbl = {{ -100000, 1 },    -- bugs walkaround
					...
					{  65, 0.39 },			
					{  1000, 0.39 }} 
-- baselines rescaled to M's acf _jet_SFC_hicrz/_locrz ratio (M donor trusts the acf directly,
-- has no runtime override; B's own alt-based correction curve below is kept unchanged)
local SFC_hi_base=0.000019873102
local SFC_lo_base=0.000019731355
