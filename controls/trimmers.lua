...
-- defineProperty("absu_debug1", globalPropertyf("sim/custom/controlls/absu_debug1")) 
-- defineProperty("absu_debug2", globalPropertyf("sim/custom/controlls/absu_debug2")) 
...
defineProperty("absu_pitch_trimm", globalPropertyi("sim/custom/absu/absu_pitch_trimm")) -- комманда триммеру от АБСУ. +1 = вверх, -1 = ввениз
...
defineProperty("absu_roll_mode", globalPropertyi("sim/custom/gauges/console/absu_roll_mode")) -- режим работы АБСУ. 0 - выкл, 1 - штурвальный, 2 - стаб
defineProperty("absu_pitch_mode", globalPropertyi("sim/custom/gauges/console/absu_pitch_mode")) -- режим работы АБСУ. 0 - выкл, 1 - штурвальный, 2 - стаб
...
defineProperty("ctr_36L_cc", globalPropertyf("sim/custom/control/ctr_36L_cc")) -- нагрузка на сеть
defineProperty("ctr_36R_cc", globalPropertyf("sim/custom/control/ctr_36R_cc")) -- нагрузка на сеть
...
local trimm_el = loadSample('Custom Sounds/new_snds/trimm_EL.wav') --
local trimm_rn = loadSample('Custom Sounds/new_snds/trimm_RN.wav') --
