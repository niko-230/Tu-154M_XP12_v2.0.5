...
-- defineProperty("elev_debug1", globalPropertyf("sim/custom/controlls/elevator_debug1")) 
-- defineProperty("elev_debug2", globalPropertyf("sim/custom/controlls/elevator_debug2")) 

defineProperty("joy_pitch", globalPropertyf("sim/custom/SC/yoke_pitch_ratio")) 
defineProperty("joy_roll", globalPropertyf("sim/custom/SC/yoke_roll_ratio")) 
defineProperty("joy_yaw", globalPropertyf("sim/custom/SC/yoke_heading_ratio")) 
...
defineProperty("elev_trimm_sw", globalPropertyi("sim/custom/controll/elev_trimm_switcher")) -- ручка управления триммером РВ. -1 - пикирование, 0 - нейтр, +1 кабрирование
...
defineProperty("spd_brk_inn_anim_L", globalPropertyf("sim/custom/anim/spd_brk_inn_left")) -- inner speedbrake left animation Degrees
defineProperty("spd_brk_inn_anim_R", globalPropertyf("sim/custom/anim/spd_brk_inn_right")) -- inner speedbrake right animation Degrees
...
-- animations
defineProperty("yoke_pitch", globalPropertyf("sim/custom/controlls/yoke_pitch")) -- поворот штурвала ко тангажу
defineProperty("yoke_roll", globalPropertyf("sim/custom/controlls/yoke_roll")) -- поворот штурвала ко тангажу
defineProperty("pedals_turn", globalPropertyf("sim/custom/controlls/pedals")) -- поворот штурвала ко тангажу
defineProperty("spoilers_lever", globalPropertyf("sim/custom/controlls/spoilers_lever")) -- рычаг интерцепторов
...
-- currents
defineProperty("ctr_27_L_cc", globalPropertyf("sim/custom/control/ctr_27_L_cc")) -- нагрузка на сеть
defineProperty("ctr_27_R_cc", globalPropertyf("sim/custom/control/ctr_27_R_cc")) -- нагрузка на сеть

defineProperty("ctr_115_1_cc", globalPropertyf("sim/custom/control/ctr_115_1_cc")) -- нагрузка на сеть
defineProperty("ctr_115_2_cc", globalPropertyf("sim/custom/control/ctr_115_2_cc")) -- нагрузка на сеть
defineProperty("ctr_115_3_cc", globalPropertyf("sim/custom/control/ctr_115_3_cc")) -- нагрузка на сеть
...
defineProperty("kontur_on", globalPropertyf("sim/custom/b2/kontur_on")) -- 
defineProperty("spb_inn_anim", globalPropertyf("sim/custom/b2/spb_inn_anim")) -- 

defineProperty("elev_coeff", globalPropertyf("sim/custom/controlls/elev_coeff"))

defineProperty("nosewheel_turn_sel", globalPropertyi("sim/custom/switchers/nosewheel_turn_sel"))
defineProperty("yoke_offset", globalPropertyf("sim/custom/controlls/yoke_offset"))
...
defineProperty("elev_L_ph", globalPropertyf("sim/custom/controlls/elev_L_phys"))
defineProperty("elev_R_ph", globalPropertyf("sim/custom/controlls/elev_R_phys"))

--defineProperty("db1", globalPropertyf("sim/custom/controlls/debug1"))
