...
-- NAV DEVICE SELECTION GATE (added — makes KLN90 yield when UNS is selected,
-- since KLN90 and UNS share the same screen position={1018,506,1029,329} slot
-- in avionics.lua and were previously both unconditionally clickable there)
defineProperty("show_UNS_gate", globalPropertyi("sim/custom/anim/UNS"))
...
components = {
	...
	KLN90_3d { 
			...
			visible = function() return get(show_UNS_gate) == 0 end,
	},
