...
local reverse_table = {{ -10000, 0.04 }, -- BUGS workaround
	...
	-- set(db2,rud_lim_2)
	rud_lim=0.03 -- see note above, was 0.25 (B's original, untuned, no M equivalent exists -- this is a from-scratch retune anchored to the real РЛЭ spool-time range)
