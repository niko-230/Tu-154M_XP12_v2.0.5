...
defineProperty("kln_course_out", createGlobalPropertyf("custom/kln90/kln_course"))
defineProperty("kln_dev_out", createGlobalPropertyf("custom/kln90/kln_dev"))
...
defineProperty("kln_pow", globalPropertyi("sim/cockpit/electrical/battery_on"))
...
function update()
					  ...
					  if values["activeWPT"]["length"] >= 2 then
						...
						if values["primary"] == 1 then
						  ...
						  if get(HSIsource) == 2 then
							...
							set(kln_course_out, values["DTK"])
							set(kln_dev_out, values["XTK"])
							set(GPSRelBear, diff)
	...
	-- set results for Tu154 ABSU
		if get(power) == 1 then
			...
			set(kln_course_out, values["DTK"]) -- added: M's ABSU bridge
			set(kln_dev_out, values["XTK"]) -- added: M's ABSU bridge
		else
			set(kln_course, 0)
			set(kln_dev, 0)
			set(kln_course_out, 0) -- added: M's ABSU bridge
			set(kln_dev_out, 0) -- added: M's ABSU bridge
			set(kln_flag, 0)
			set(WPTalert, 0)
			set(MSGalert, 0)
		end
...
function draw()
		if draw3d == true then
			...
			sasl.gl.drawBitmapText(font, 1, 69, gline[1], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
			sasl.gl.drawBitmapText(font, 1, 58, gline[2], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
			sasl.gl.drawBitmapText(font, 1, 47, gline[3], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
			sasl.gl.drawBitmapText(font, 1, 36, gline[4], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
			sasl.gl.drawBitmapText(font, 1, 25, gline[5], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
			sasl.gl.drawBitmapText(font, 1, 14, gline[6], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
			sasl.gl.drawBitmapText(font, 1, 0, gline[7], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
			sasl.gl.drawBitmapText(fontb, 1, 69, bline[1], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
			sasl.gl.drawBitmapText(fontb, 1, 58, bline[2], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
			sasl.gl.drawBitmapText(fontb, 1, 47, bline[3], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
			sasl.gl.drawBitmapText(fontb, 1, 36, bline[4], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
			sasl.gl.drawBitmapText(fontb, 1, 25, bline[5], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
			sasl.gl.drawBitmapText(fontb, 1, 14, bline[6], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
			sasl.gl.drawBitmapText(fontb, 1, 0, bline[7], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
			sasl.gl.drawBitmapText(fontl, 5.5, 58, values["scaleline"], TEXT_ALIGN_LEFT, brt*power_timer, brt*power_timer, brt*power_timer)
			sasl.gl.drawTexture(get(cage), 0, 27, 208, 1, {brt*power_timer*cagevisible, brt*power_timer*cagevisible, brt*power_timer*cagevisible})
			drawAll(Nav5Comp)
			drawAll(APT3Comp)
