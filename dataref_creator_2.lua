...
createGlobalPropertyi("sim/custom/lang/hide_eng_normal", 1) -- eng cockpit, non-UNS equipment
createGlobalPropertyi("sim/custom/lang/hide_eng_uns", 1) -- eng cockpit, UNS equipment
createGlobalPropertyi("sim/custom/lang/hide_rus_normal", 1) -- rus cockpit, non-UNS equipment
createGlobalPropertyi("sim/custom/lang/hide_rus_uns", 1) -- rus cockpit, UNS equipment
createGlobalPropertyi("sim/custom/lang/hide_uns_objects", 1) -- placeholder, always hidden until show/hide logic is decided (chairs/details/glass/lt/shtorki)
createGlobalPropertyi("sim/custom/lang/hide_uns_keypad", 1) -- hides the UNS CDU keypad object except when UNS is selected (either language)
...
createGlobalPropertyf("sim/custom/elec/bus115_freq", 0																) -- ток в сети 115в
...
createGlobalPropertyi("sim/custom/fuel/pump_tank2_left_work1", 1																) -- насосы бака 2
createGlobalPropertyi("sim/custom/fuel/pump_tank2_right_work1", 1																) -- насосы бака 2
createGlobalPropertyi("sim/custom/fuel/pump_tank2_left_work2", 1																) -- насосы бака 2
createGlobalPropertyi("sim/custom/fuel/pump_tank2_right_work2", 1																) -- насосы бака 2
createGlobalPropertyi("sim/custom/fuel/pump_tank3_left_work1", 1																) -- насосы бака 3
createGlobalPropertyi("sim/custom/fuel/pump_tank3_right_work1", 1																) -- насосы бака 3
createGlobalPropertyi("sim/custom/fuel/pump_tank3_left_work2", 1																) -- насосы бака 3
createGlobalPropertyi("sim/custom/fuel/pump_tank3_right_work2", 1																) -- насосы бака 3
createGlobalPropertyi("sim/custom/fuel/pump_tank3_left_work3", 1																) -- насосы бака 3
createGlobalPropertyi("sim/custom/fuel/pump_tank3_right_work3", 1																) -- насосы бака 3
createGlobalPropertyi("sim/custom/fuel/pump_tank4_work1", 1																) -- насосы бака 4
createGlobalPropertyi("sim/custom/fuel/pump_tank4_work2", 1																) -- насосы бака 4
...
createGlobalPropertyf("sim/custom/UNS/kln_course", 0																) -- курс ЛЗП от КЛН
createGlobalPropertyf("sim/custom/UNS/kln_dev", 0																) -- отклонение от ЛЗП, мили
createGlobalPropertyi("sim/custom/UNS/kln_flag", 0																) -- флаг курса КЛН. 0 = флага нет, 1 = флаг
...
createGlobalPropertyi("sim/custom/payload/crew_num", 4) -- экипаж в кабине
...
createGlobalPropertyf("sim/custom/UNS/gps_course_degtm", 0) -- курс ЛЗП от UNS (was unregistered placeholder)
createGlobalPropertyf("sim/custom/UNS/gps_cross_track_nm", 0) -- отклонение от ЛЗП от UNS (was unregistered placeholder)
createGlobalPropertyf("sim/custom/UNS/hsi_flag_from_to_pilot", 0) -- флаг на UNS (was unregistered placeholder)
createGlobalPropertyi("sim/custom/elec/apu_apd_working",0)
createGlobalPropertyf("sim/custom/absu/cmd_pitch", 0																) -- отклонение штока РА56 по тангажу
createGlobalPropertyf("sim/custom/absu/cmd_roll", 0																) -- отклонение штока РА56 по крену
createGlobalPropertyf("sim/custom/absu/cmd_yaw", 0																) -- отклонение штока РА56 по направлению
createGlobalPropertyf("sim/custom/absu/d_ra1_p",0)
createGlobalPropertyf("sim/custom/absu/d_ra2_p",0)
createGlobalPropertyf("sim/custom/absu/d_ra3_p",0)
createGlobalPropertyf("sim/custom/absu/d_ra1_r",0)
createGlobalPropertyf("sim/custom/absu/d_ra2_r",0)
createGlobalPropertyf("sim/custom/absu/d_ra3_r",0)
createGlobalPropertyf("sim/custom/absu/d_ra1_y",0)
createGlobalPropertyf("sim/custom/absu/d_ra2_y",0)
createGlobalPropertyf("sim/custom/absu/d_ra3_y",0)
createGlobalPropertyi("sim/custom/failures/rsbn_rec",0)-- RSBN is receiving signal
createGlobalPropertyi("sim/custom/fire/fire_bag1",0)
createGlobalPropertyi("sim/custom/fire/fire_bag2",0)
createGlobalPropertyi("sim/custom/fire/eng1_ext_used",0)
createGlobalPropertyi("sim/custom/fire/eng2_ext_used",0)
createGlobalPropertyi("sim/custom/fire/eng3_ext_used",0)
createGlobalPropertyi("sim/custom/fire/apu_ext_used",0)
createGlobalPropertyf("sim/custom/elec/avto_L_volt",0)
createGlobalPropertyf("sim/custom/elec/avto_R_volt",0)
createGlobalPropertyf("sim/custom/elec/avto_L_amp",0)
createGlobalPropertyf("sim/custom/elec/avto_R_amp",0)
createGlobalPropertyf("sim/custom/elec/fuel_pumps_115_aL_cc",0) 
createGlobalPropertyf("sim/custom/elec/fuel_pumps_115_aR_cc",0)
createGlobalPropertyi("sim/custom/SC/engine/rt_stop1",0)
createGlobalPropertyf("sim/custom/SC/engine/rt_red1",0)
createGlobalPropertyi("sim/custom/SC/engine/rt_stop2",0)
createGlobalPropertyf("sim/custom/SC/engine/rt_red2",0)
createGlobalPropertyi("sim/custom/SC/engine/rt_stop3",0)
createGlobalPropertyf("sim/custom/SC/engine/rt_red3",0)
createGlobalPropertyf("sim/custom/lights/engines/eng1_t_high",0)
createGlobalPropertyf("sim/custom/lights/engines/eng2_t_high",0)
createGlobalPropertyf("sim/custom/lights/engines/eng3_t_high",0)
createGlobalPropertyf("sim/custom/lights/engines/egt_nk8_1",0)
createGlobalPropertyf("sim/custom/lights/engines/egt_nk8_2",0)
createGlobalPropertyf("sim/custom/lights/engines/egt_nk8_3",0)
createGlobalPropertyi("sim/custom/engines/rna_1",0)
createGlobalPropertyi("sim/custom/engines/rna_2",0)
createGlobalPropertyi("sim/custom/engines/rna_3",0)
createGlobalPropertyf("sim/custom/engines/flight_idle",0)
createGlobalPropertyf("sim/custom/engines/flight_idle_rpm",0)
createGlobalPropertyf("sim/custom/engines/delta_FF",0)
createGlobalPropertyf("sim/custom/engines/FuelFlow_1",0)
createGlobalPropertyf("sim/custom/engines/FuelFlow_2",0)
createGlobalPropertyf("sim/custom/engines/FuelFlow_3",0)
createGlobalPropertyi("sim/custom/antiice/stab_heat_open", 0)
createGlobalPropertyf("sim/custom/engines/nk_rotation_1",0)
createGlobalPropertyf("sim/custom/engines/nk_rotation_3",0)
createGlobalPropertyf("sim/custom/anim/tiller_pos",0)
createGlobalPropertyi("sim/custom/hydro/nosewheel_turn_power", 0)
createGlobalPropertyf("sim/custom/SC/engine/nk8_kvd1", 0)
createGlobalPropertyf("sim/custom/SC/engine/nk8_kvd2", 0)
createGlobalPropertyf("sim/custom/SC/engine/nk8_kvd3", 0)
createGlobalPropertyf("sim/custom/absu/d_H_integral", 0) 
createGlobalPropertyf("sim/custom/absu/d_V_integral", 0) 
createGlobalPropertyf("sim/custom/absu/d_M_integral", 0) 
createGlobalPropertyi("sim/custom/failures/absu_bdg_tet_1_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_bdg_tet_2_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_bdg_tet_3_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_bdg_gam_1_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_bdg_gam_2_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_bdg_gam_3_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_bdg_psi_1_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_bdg_psi_2_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_bdg_psi_3_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_bap_thet_1_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_bap_thet_2_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_bap_thet_3_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_bap_gam_1_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_bap_gam_2_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_bap_gam_3_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_stu_thet_1_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_stu_thet_2_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_stu_thet_3_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_stu_gam_1_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_stu_gam_2_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_stu_gam_3_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_vu1_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_vu2_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_vu3_fail", 0) 
createGlobalPropertyi("sim/custom/failures/mgv_thet_1_fail", 0) 
createGlobalPropertyi("sim/custom/failures/mgv_thet_2_fail", 0) 
createGlobalPropertyi("sim/custom/failures/mgv_thet_3_fail", 0) 
createGlobalPropertyi("sim/custom/failures/mgv_gam_1_fail", 0) 
createGlobalPropertyi("sim/custom/failures/mgv_gam_2_fail", 0) 
createGlobalPropertyi("sim/custom/failures/mgv_gam_3_fail", 0) 
createGlobalPropertyi("sim/custom/failures/absu_vkv_fail", 0)
createGlobalPropertyi("sim/custom/failures/absu_alt_speed_fail", 0)
createGlobalPropertyi("sim/custom/failures/absu_at_fail", 0)
createGlobalPropertyi("sim/custom/failures/absu_man_at", 0)
createGlobalPropertyi("sim/custom/failures/absu_bdlu_fail", 0)
createGlobalPropertyi("sim/custom/failures/absu_work_state", 0)
createGlobalPropertyi("sim/custom/failures/absu_at_chan1_fail", 0)
createGlobalPropertyi("sim/custom/failures/absu_at_chan2_fail", 0)
createGlobalPropertyi("sim/custom/failures/ute_1_fail", 0)
createGlobalPropertyi("sim/custom/failures/ute_2_fail", 0) 
createGlobalPropertyi("sim/custom/failures/ute_1_fail_mem", 0)
createGlobalPropertyi("sim/custom/failures/ute_2_fail_mem", 0) 
createGlobalPropertyi("sim/custom/absu/at_fail_signal", 0) 
createGlobalPropertyi("sim/custom/failures/bshu_tet_1_fail", 0)
createGlobalPropertyi("sim/custom/failures/bshu_tet_2_fail", 0)
createGlobalPropertyi("sim/custom/failures/bshu_tet_3_fail", 0)
createGlobalPropertyi("sim/custom/failures/bshu_tet_1_fail_mem", 0)
createGlobalPropertyi("sim/custom/failures/bshu_tet_2_fail_mem", 0)
createGlobalPropertyi("sim/custom/failures/bshu_tet_3_fail_mem", 0)
createGlobalPropertyi("sim/custom/failures/bshu_gam_1_fail", 0)
createGlobalPropertyi("sim/custom/failures/bshu_gam_2_fail", 0)
createGlobalPropertyi("sim/custom/failures/bshu_gam_3_fail", 0)
createGlobalPropertyi("sim/custom/failures/bshu_gam_1_fail_mem", 0)
createGlobalPropertyi("sim/custom/failures/bshu_gam_2_fail_mem", 0)
createGlobalPropertyi("sim/custom/failures/bshu_gam_3_fail_mem", 0)
createGlobalPropertyi("sim/custom/failures/bshu_tet_fail", 0)
createGlobalPropertyi("sim/custom/failures/bshu_gam_fail", 0)
createGlobalPropertyi("sim/custom/failures/absu_at_blocked", 0)
createGlobalPropertyi("sim/custom/absu/ppn_search_delay", 0) 
createGlobalPropertyf("sim/custom/kskv/ard_temp", 0)
createGlobalPropertyi("sim/custom/failures/bns_tet_1_fail", 0)
createGlobalPropertyi("sim/custom/failures/bns_tet_2_fail", 0)
createGlobalPropertyi("sim/custom/failures/bns_tet_3_fail", 0)
createGlobalPropertyi("sim/custom/failures/bns_tet_1_fail_mem", 0)
createGlobalPropertyi("sim/custom/failures/bns_tet_2_fail_mem", 0)
createGlobalPropertyi("sim/custom/failures/bns_tet_3_fail_mem", 0)
createGlobalPropertyi("sim/custom/failures/bns_gam_1_fail", 0)
createGlobalPropertyi("sim/custom/failures/bns_gam_2_fail", 0)
createGlobalPropertyi("sim/custom/failures/bns_gam_3_fail", 0)
createGlobalPropertyi("sim/custom/failures/bns_gam_1_fail_mem", 0)
createGlobalPropertyi("sim/custom/failures/bns_gam_2_fail_mem", 0)
createGlobalPropertyi("sim/custom/failures/bns_gam_3_fail_mem", 0)
createGlobalPropertyi("sim/custom/failures/bns_tet_fail", 0)
createGlobalPropertyi("sim/custom/failures/bns_gam_fail", 0)
createGlobalPropertyi("sim/custom/failures/nvu_vor_avtomat_fail", 0)
createGlobalPropertyi("sim/custom/eng/apu_ready", 0	)
-- Added: custom datarefs donor creates via XTLua (T154.zmisc.lua/T154.vbe_cm.lua/
-- T154.uns_i.lua) that v2.0.5 never had at all, needed for radio compass needle,
-- UNS power/brightness, and altimeter needle. Created here (not in the
-- compass_adf_driver.lua/uns_gauge_driver.lua files that USE them) to match
-- this codebase's established convention of separating dataref creation from
-- the components that read/write them.
createGlobalPropertyf("sim/custom/radio/compass_adf1", 0)
createGlobalPropertyf("sim/custom/radio/compass_adf2", 0)
-- uns1_on/uns2_on: removed duplicate float registration here, 2026-08-13.
-- Already registered as int in dataref_creator_1.lua, and that's what the
-- 3D cockpit manip + sibling ovhd switches expect. The duplicate float
-- registration was shadowing/conflicting with the int one, so the manip's
-- click never visibly reached script-side readers (panels_2d.lua/gns430.lua).
createGlobalPropertyf("sim/custom/uns/brt_l", 0)
createGlobalPropertyf("sim/custom/uns/brt_r", 0)
createGlobalPropertyf("sim/custom/uns_vor1_freq", 0)
createGlobalPropertyf("sim/custom/uns_vor2_freq", 0)
createGlobalPropertyf("sim/custom/switchers/uns_vor1_a", 0)
createGlobalPropertyf("sim/custom/switchers/uns_vor2_a", 0)
createGlobalPropertyf("sim/custom/gauges/alt/vbe_cm_l_needle", 0)
createGlobalPropertyf("sim/custom/gauges/alt/vbe_cm_r_needle", 0)
createGlobalPropertyf("sim/custom/gauges/alt/vbe_cm_l_brt", 0)
createGlobalPropertyf("sim/custom/gauges/alt/vbe_cm_r_brt", 0)
