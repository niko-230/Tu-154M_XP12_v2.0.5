...
createGlobalPropertyi("sim/custom/anim/show_kln_glass", 1) -- combined: KLN90/UNS screen glass visible whenever show_gns==0 OR UNS mode active
createGlobalPropertyi("sim/custom/anim/UNS", 1) -- в системе установлена UNS
...
createGlobalPropertyf("sim/custom/anim/deice", 500) -- деайс
createGlobalPropertyf("sim/custom/anim/deice2", 0) -- деайс
...
createGlobalPropertyf("sim/custom/lights/km_panel_flood_set", 0.3) -- регулятор яркости освещения панели КМ
...
createGlobalPropertyi("sim/custom/switchers/ovhd/uns2_on", 1) -- выключатель UNS 2
...
createGlobalPropertyi("sim/custom/switchers/ovhd/uns1_on", 1) -- выключатель UNS 1
...
createGlobalPropertyi("sim/custom/ovhd/so72_code", 0) -- кнопка знак
...
createGlobalPropertyi("sim/custom/switchers/uns_vor1_a", 0) -- UNS источник VOR 1
createGlobalPropertyi("sim/custom/switchers/uns_vor2_a", 0) -- UNS источник VOR 2
...
createGlobalPropertyf("sim/custom/lights/km_panel_flood", 0) -- яркость освещения панели КМ
...
createGlobalPropertyi("sim/custom/rotary/UNS/3D_L_Angle", 0) -- поворот левой ручки КЛН90
createGlobalPropertyi("sim/custom/rotary/UNS/3D_R_Angle", 0) -- поворот правой ручки КЛН90
createGlobalPropertyi("sim/custom/rotary/UNS/power_knob", 0) -- вытягивание ручки питания
createGlobalPropertyi("sim/custom/rotary/UNS/power_knob_angle", 0) -- поворот ручки питания КЛН90
createGlobalPropertyi("sim/custom/rotary/UNS/scan_knob", 0) -- вытягивание ручки scan
...
createGlobalPropertyi("sim/custom/switchers/uns_knob_out", 0) -- вытягивание ручки КЛН
createGlobalPropertyi("sim/custom/switchers/uns_power_knob", 0) -- вдавливание ручки питания КЛН
...
createGlobalPropertyf("sim/custom/egpws/dis_sound", 0)
createGlobalPropertyf("sim/custom/egpws/dis_gs", 0)
createGlobalPropertyf("sim/custom/egpws/dis_rppz", 0)
createGlobalPropertyf("sim/custom/egpws/dis_flaps", 0)
createGlobalPropertyf("sim/custom/egpws/dis_gear", 0)
createGlobalPropertyf("sim/custom/b2/kontur_on", 0) 
createGlobalPropertyf("sim/custom/b2/spb_inn_anim", 0) 
createGlobalPropertyf("sim/custom/kontur/srpbz", 0) 
createGlobalPropertyf("sim/custom/gauges/airbleed/cabin_alt_new", 0) 
createGlobalPropertyf("sim/custom/gauges/airbleed/cabin_diff_new", 0) 
createGlobalPropertyf("sim/custom/vyzov_bp_ready", 0) 
createGlobalPropertyi("sim/custom/buttons/console/absu_nvu_arm", 0)
createGlobalPropertyi("sim/custom/buttons/console/absu_az1_arm", 0)
createGlobalPropertyi("sim/custom/buttons/console/absu_az2_arm", 0)
createGlobalPropertyf("sim/custom/controlls/elev_coeff",0.6)
createGlobalPropertyf("sim/custom/controlls/yoke_offset",0)
createGlobalPropertyf("sim/custom/controlls/elev_L_phys", 0)
createGlobalPropertyf("sim/custom/controlls/elev_R_phys", 0)
createGlobalPropertyf("sim/custom/controlls/debug1", 1)
createGlobalPropertyf("sim/custom/controlls/debug2", 1)
createGlobalPropertyf("sim/custom/controlls/debug3", 1)
createGlobalPropertyf("sim/custom/controlls/target_n2_1",0)
createGlobalPropertyf("sim/custom/controlls/target_n2_2",0)
createGlobalPropertyf("sim/custom/controlls/target_n2_3",0)
createGlobalPropertyf("sim/engine/max_KVD",0)
createGlobalPropertyf("sim/engine/kpp_up",0)
createGlobalPropertyf("sim/engine/kpp_dn",0)
createGlobalPropertyi("sim/custom/absu_power_27", 0)
createGlobalPropertyf("sim/custom/engines/d_isa_temp", 0)
createGlobalPropertyf("sim/custom/engines/engine2_case_temp", 0)
createGlobalPropertyf("sim/custom/controlls/ail_L_phys", 0)
createGlobalPropertyf("sim/custom/controlls/ail_R_phys", 0)
createGlobalPropertyf("sim/custom/controlls/spoil_L_phys", 0)
createGlobalPropertyf("sim/custom/controlls/spoil_R_phys", 0)
createGlobalPropertyf("sim/custom/controlls/rudder_coeff",1)
-- UNS donor root shell (tu154_UNS_cockpit.obj) support datarefs, added 2026-08-09
-- these 58 were referenced by the donor root shell but never registered; defaults are conservative guesses
-- (0/off, or float 0.0) except uns1_on/uns2_on which mirror the sibling ovhd-switch default of 1
createGlobalPropertyi("sim/custom/uns1_on", 1)
createGlobalPropertyi("sim/custom/uns2_on", 1)
createGlobalPropertyi("sim/custom/anim/cockpit_window_left_slide", 0)
createGlobalPropertyi("sim/custom/anim/cockpit_window_right_slide", 0)
createGlobalPropertyi("sim/custom/kontur/weather_sys", 0)
createGlobalPropertyi("sim/custom/radio/spu2_on", 0)
createGlobalPropertyi("sim/custom/radios/vhf1_ap", 0)
createGlobalPropertyi("sim/custom/radios/vhf1_ps", 0)
createGlobalPropertyi("sim/custom/radios/vhf2_ap", 0)
createGlobalPropertyi("sim/custom/radios/vhf2_ps", 0)
createGlobalPropertyi("sim/custom/switchers/emerg_trimm_azs", 0)
createGlobalPropertyi("sim/custom/switchers/eng/szt_1", 0)
createGlobalPropertyi("sim/custom/switchers/eng/szt_2", 0)
createGlobalPropertyi("sim/custom/switchers/eng/szt_3", 0)
createGlobalPropertyi("sim/custom/t154_efb/cable_connect", 0)
createGlobalPropertyi("sim/custom/t154_efb/efb_power_mode", 0)
createGlobalPropertyi("sim/custom/t154_efb/power_btn", 0)
createGlobalPropertyi("sim/custom/gauges/alt/vbe_cm_l_btn_mode", 0)
createGlobalPropertyi("sim/custom/gauges/alt/vbe_cm_r_btn_mode", 0)
createGlobalPropertyi("sim/custom/kontur/left_on", 0)
createGlobalPropertyi("sim/custom/kontur/left_taws", 0)
createGlobalPropertyi("sim/custom/kontur/right_on", 0)
createGlobalPropertyi("sim/custom/kontur/right_taws", 0)
createGlobalPropertyi("sim/custom/radios/vhf1_100mode", 0)
createGlobalPropertyi("sim/custom/radios/vhf2_100mode", 0)
createGlobalPropertyi("sim/custom/t154_efb/enabled", 0)
createGlobalPropertyi("sim/custom/t154_efb/page", 0)
createGlobalPropertyi("sim/custom/t154_efb/popup_1", 0)
createGlobalPropertyi("sim/custom/t154_efb/popup_2", 0)
createGlobalPropertyi("sim/custom/t154_efb/popup_3", 0)
createGlobalPropertyi("sim/custom/t154_efb/popup_4", 0)
createGlobalPropertyi("sim/custom/t154_efb/popup_5", 0)
createGlobalPropertyi("sim/custom/t154_efb/power", 0)
createGlobalPropertyf("sim/custom/buttons/misc/gforce_reset_but", 0)
createGlobalPropertyf("sim/custom/kontur/info_knob1_l", 0)
createGlobalPropertyf("sim/custom/kontur/info_knob1_r", 0)
createGlobalPropertyf("sim/custom/kontur/info_knob2_l", 0)
createGlobalPropertyf("sim/custom/kontur/info_knob2_r", 0)
createGlobalPropertyf("sim/custom/kontur/kntr_1_brt_sw", 0)
createGlobalPropertyf("sim/custom/kontur/kntr_2_brt_sw", 0)
createGlobalPropertyf("sim/custom/kontur/rru_l", 0)
createGlobalPropertyf("sim/custom/kontur/rru_r", 0)
createGlobalPropertyf("sim/custom/kontur/srpbz_lit_set", 0)
createGlobalPropertyf("sim/custom/kontur/weather_mode", 0)
createGlobalPropertyf("sim/custom/misc/itv_cap", 0)
createGlobalPropertyf("sim/custom/switchers/console/busters_cap_new", 0)
createGlobalPropertyf("sim/custom/switchers/eng/szt_test", 0)
createGlobalPropertyf("sim/custom/switchers/eng/szt_test_cap", 0)
createGlobalPropertyf("sim/custom/switchers/fuel/pump_tank1_1_cap", 0)
createGlobalPropertyf("sim/custom/switchers/fuel/pump_tank1_2_cap", 0)
createGlobalPropertyf("sim/custom/switchers/fuel/pump_tank1_3_cap", 0)
createGlobalPropertyf("sim/custom/switchers/fuel/pump_tank1_4_cap", 0)
createGlobalPropertyf("sim/custom/switchers/vbe_select_cap", 0)
createGlobalPropertyf("sim/custom/t154_efb/fc_wind_corr", 0)
createGlobalPropertyf("sim/custom/t154_efb/fc_wind_corr_alt", 0)
createGlobalPropertyf("sim/custom/tcas2000/mode", 0)
createGlobalPropertyf("sim/custom/wx2000_gain", 0)
createGlobalPropertyf("sim/custom/yoke_height", 0)
