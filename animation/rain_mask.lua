...
-- dataRefs
defineProperty("wiper_angle_left", globalPropertyf("sim/custom/anim/wiper_angle_left"))
defineProperty("wiper_angle_right", globalPropertyf("sim/custom/anim/wiper_angle_right"))

-- enviroment
defineProperty("actual_rain", globalPropertyf("sim/weather/aircraft/precipitation_on_aircraft_ratio"))

defineProperty("net_rain_ratio", globalPropertyf("sim/custom/anim/net_rain_ratio"))
...
local mask = {}
for i = 1, 2 do
	mask[i] = globalPropertyf("sim/custom/anim/rain_glass_"..i)
end
...
for i = 1, 2 do
	...
	for y = 1, 5 do
		table.insert(wiper_mask_L[i], globalPropertyf("sim/custom/anim/rain_glass_"..i.."_w_"..y.."_L"))
		table.insert(wiper_mask_R[i], globalPropertyf("sim/custom/anim/rain_glass_"..i.."_w_"..y.."_R"))
	end
end
...
sim/custom/anim/rain_glass_1
sim/custom/anim/rain_glass_2



sim/custom/anim/rain_glass_1_w_1_L
sim/custom/anim/rain_glass_1_w_2_L
sim/custom/anim/rain_glass_1_w_3_L
sim/custom/anim/rain_glass_1_w_4_L
sim/custom/anim/rain_glass_1_w_5_L

sim/custom/anim/rain_glass_2_w_1_L
sim/custom/anim/rain_glass_2_w_2_L
sim/custom/anim/rain_glass_2_w_3_L
sim/custom/anim/rain_glass_2_w_4_L
sim/custom/anim/rain_glass_2_w_5_L



sim/custom/anim/rain_glass_1_w_1_R
sim/custom/anim/rain_glass_1_w_2_R
sim/custom/anim/rain_glass_1_w_3_R
sim/custom/anim/rain_glass_1_w_4_R
sim/custom/anim/rain_glass_1_w_5_R

sim/custom/anim/rain_glass_2_w_1_R
sim/custom/anim/rain_glass_2_w_2_R
sim/custom/anim/rain_glass_2_w_3_R
sim/custom/anim/rain_glass_2_w_4_R
sim/custom/anim/rain_glass_2_w_5_R
