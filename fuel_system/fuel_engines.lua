...
-- controls
defineProperty("fire_valve_1", globalPropertyi("sim/custom/switchers/fuel/fire_valve_1")) -- пожарный кран
defineProperty("fire_valve_2", globalPropertyi("sim/custom/switchers/fuel/fire_valve_2")) -- пожарный кран
defineProperty("fire_valve_3", globalPropertyi("sim/custom/switchers/fuel/fire_valve_3")) -- пожарный кран
...
-- animation
defineProperty("fuel_cutoff_1", globalPropertyf("sim/custom/controlls/fuel_cutoff_1")) -- рычаг пожарного крана
defineProperty("fuel_cutoff_2", globalPropertyf("sim/custom/controlls/fuel_cutoff_2")) -- рычаг пожарного крана
defineProperty("fuel_cutoff_3", globalPropertyf("sim/custom/controlls/fuel_cutoff_3")) -- рычаг пожарного крана

-- time
defineProperty("frame_time", globalPropertyf("sim/custom/time/frame_time")) -- flight time

-- results
defineProperty("eng_fuel_press_1", globalPropertyi("sim/custom/fuel/eng_fuel_press_1")) -- топливо может быть подано в двигатель. без учета стоп-кранов
defineProperty("eng_fuel_press_2", globalPropertyi("sim/custom/fuel/eng_fuel_press_2")) -- топливо может быть подано в двигатель. без учета стоп-кранов
defineProperty("eng_fuel_press_3", globalPropertyi("sim/custom/fuel/eng_fuel_press_3")) -- топливо может быть подано в двигатель. без учета стоп-кранов

defineProperty("fire_vlv_open_1", globalPropertyf("sim/custom/fuel/fire_vlv_open_1")) -- пожарный кран открыт
defineProperty("fire_vlv_open_2", globalPropertyf("sim/custom/fuel/fire_vlv_open_2")) -- пожарный кран открыт
defineProperty("fire_vlv_open_3", globalPropertyf("sim/custom/fuel/fire_vlv_open_3")) -- пожарный кран открыт
...
defineProperty("rt1_stop", globalPropertyi("sim/custom/SC/engine/rt_stop1"))
defineProperty("rt2_stop", globalPropertyi("sim/custom/SC/engine/rt_stop2"))
defineProperty("rt3_stop", globalPropertyi("sim/custom/SC/engine/rt_stop3"))
